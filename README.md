...
<details>
  <summary><b>🇨🇳 点击展开中文简介</b></summary>

  <br/>

  # 👋 你好，我是 曾兆杰（Zhaojie Zeng）

  华中科技大学博士生｜3D 视觉方向算法研究  
  多视图立体（MVS）· 神经渲染（NeRF）· 3D 高斯泼溅（3DGS）
  ...
  我目前在 **华中科技大学（HUST）计算机学院** 攻读博士学位，导师为 **管涛 教授**。  
  研究方向聚焦于 **计算机视觉与三维重建**，尤其是：
  ...
  **华中科技大学（HUST）**｜计算机科学与技术学院

  - 本科：计算机科学与技术（ACM 班），2017 – 2021  
  - 硕士 → 博士：计算机科学与技术，2021 – 至今
  ...
  **Matching Ambiguity-Resilient Multi-View Stereo via Adaptive Patch Deformation**  
  ...
  ⭐ 如果你也关注 3D 视觉 / 神经渲染方向，欢迎交流或查看我的仓库！
